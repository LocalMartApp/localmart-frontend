  ...
  return (
    <div className="MyProfile">
      ...
      <div className="edit-profile-section">
        <EditProfile profileData={userData} setEditProfile={setEditProfile} />
      </div> :
      <div className="inner-my-profile-section">
        <Modal
            isOpen={modalIsOpen}
            style={customStyles}
                  ...
                  <div className="col-span-9 right-profile-content-section">
                      <div className="profile-main-details-heading-part flex items-center justify-between gap-x-40">
                        ...
                        <div className="right-edit-prof-button">
                          <button type="button" onClick={() => setEditProfile(true)} className='flex items-center gap-x-[15px] rounded-full bg-Primary justify-center px-6 py-2 border border-Primary duration-300 hover:bg-white group'>
