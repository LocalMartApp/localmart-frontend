...
const MyBusinessDetail = () => {
  ...
  return (
    <div className="MyBusinessDetil">
      <div className="inner-business-detail">
        <div className="main-search-info-section">
              ...
              <div className="container">
                <div className="breadcrum-inner-section">
                  <ul className="flex items-center gap-x-2">
                    <li>
                      <NavLink className={`text-Black `}>Rajahmundry</NavLink>
                    </li>
                    <li>
                      <i className="ri-arrow-right-s-line"></i>
                    </li>
                    <li>
                      <p className={`text-Black `}>Restaurants in Mumbai</p>
                    </li>
                    <li>
                      <i className="ri-arrow-right-s-line"></i>
                    </li>
                    <li>
                      <p className={`text-Black `}>150+ Listings</p>
                    </li>
                    <li>
                      <i className="ri-arrow-right-s-line"></i>
                    </li>
                    <li>
                      <p className={`text-Black `}>Sri Megha Restaurant</p>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="search-info-page-section-2 py-10">
                    ...
                    <div className="location-rating-seperate-search flex items-center gap-x-5 mt-3">
                      ...
                      >
                        ...
                        <p className="text-sm text-LightText">
                          {receivedData?.cityId?.name} - {receivedData?.stateId?.name}
                        </p>
                      </button>
                ...
                <div className="photos-section-searched my-5">
                  <div className="grid grid-cols-12 gap-5">
                    ...
                    <div className="col-span-2">
                      <div className="small-image-section-searched searched-image-sections h-full max-h-[360px]">
                        <div className="grid grid-cols-2 gap-y-5 h-full">
                          <div className="med-image-section-searched searched-image-sections h-full col-span-2">
                            <img
                              src={SingleSearchImage3}
                              className="h-full w-full rounded-xl"
                              alt=""
                            />
                          </div>
                        ...
                        <div className="inner-about-rating-section flex flex-col gap-y-10">
                          <div className="top-about-para-section-searched">
                            ...
                            <p className="text-Black opacity-70">
                              Beautiful stylish and spacious 2-Bedroom, with 1
                              king and 1 queen size bed, and 1 free parking spot
                              plus visitor parking. Located in one of the best
                              areas of Downtown Toronto, just a few minutes walk
                              from the CN tower, Rogers Stadium, Scotiabank
                              Arena and the lakeshore. The apartment is
                              surrounded by trendy restaurants, shops and
                              venues. Close to public transit and main street{" "}
                            </p>
                          </div>
                                ...
                                return (
                                  ...
                                  >
                                    <div className="inner-single-amenities flex items-center gap-x-3">
                                      <div className="left-amanitie-icon px-4 py-2 rounded-full flex items-center justify-center bg-AmenitiesLightGray">
                          ...
                          <div className="rating-section-searched">
                            <div className="rating-searched-section flex justify-between gap-10 items-center mb-4">
                              ...
                              <div className="rating-searched-sliding-buttons flex items-center gap-7">
                                <button
                                  type="button"
                                  className="rating-searched-button-prev w-8 h-8 rounded-full bg-Secondary bg-opacity-10 "
                                >
                                  <i className="ri-arrow-left-s-line text-Secondary text-2xl"></i>
                                </button>
                                <button
                                  type="button"
                                  className="rating-searched-button-next w-8 h-8 rounded-full bg-Secondary bg-opacity-10"
                                >
                                  <i className="ri-arrow-right-s-line text-Secondary text-2xl"></i>
                                </button>
                              </div>
                          ...
                          <div className="opens-share-place-section flex flex-col gap-y-4 py-5 ">
                            <div className="opens-outer-sec flex items-center gap-x-3 text-left">
                              ...
                              <p className="font-medium text-Black">
                                Opens at{" "}
                                <span className="text-Green">{receivedData?.workingHours}</span>
                              </p>
                            </div>
                            <button
                              type="button"
