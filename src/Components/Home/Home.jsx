...
const GOOGLE_MAPS_API_KEY = "AlzaSyhhA43-gQ2a2hom7On99JaswTVRW4QZUju";
          ...
          <section className="home-section-1 relative">
            <div className="inner-home-section-1 bg-BlockBlack">
              <div className="container">
                <div
                  className={`top-main-search-section-home duration-500 z-[9999] pb-16`}
                >
                  ...
                  <div className="grid grid-cols-2 gap-x-16 items-center top-slider-grid-sec">
                    <div className="left-home-section-1">
                      <div className="heading-section-1 flex flex-col gap-5">
                        <h1 className="text-white font-semibold text-50">
                          Find Everything <br /> You Need, Every Day!
                        </h1>
                        <p className="text-white text-xl">
                          Looking for deals, services, or a place to <br /> buy
                          and sell? We’ve got you covered.
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="top-heading-part-categories flex flex-wrap justify-between gap-x-10 items-center mb-10">
                          ...
                          <div className="explore-all-cates-button">
                            <button
                              ...
                              className="explore-cities-button-prev"
                            >
                                  ...
                                  .map((items, index) => {
                                    return (
                                      <button
                                        ...
                                        key={index}
                                        className="single-recharge-component-home-sec-2 group flex flex-col justify-center items-center gap-2"
                                      >
                                        <div className="top-image-blk  w-40p h-40p flex items-center justify-center">
                                          <img
                                            src={items?.icon}
                                            className="duration-500 w-full group-hover:scale-125"
                                            alt=""
                                          />
                                        </div>
