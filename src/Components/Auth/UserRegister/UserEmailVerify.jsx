        ...
        <div className="emailregister-account-otp-section">
            <div className="login-form-otp-section flex flex-col gap-4">
                <div className="form-inputsec relative">
                    <input type="email" disabled={true} value={userEmailRegVlues.email} name="email" className={`outline-none border-none bg-LightGrayBg py-4 pl-20 pr-5 rounded-xl w-full text-Black `} 
                    />                                
