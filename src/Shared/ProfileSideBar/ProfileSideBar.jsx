      ...
      <div className="inner-sidebar-section">
              ...
              {navigationLinks.map((items, index) => {
                return (
                  <li className="single-navigator-sidebar" key={index}>
                    <NavLink
                      className="py-2 px-4 duration-300 hover:text-Primary text-Black"
                      to={items.link}
        ...
        <div className="side-bar-nav-part-after-991">
          <div className="inner-after-991-part-sidebar relative">
            <button
              type="button"
              className="menu-button-prev absolute -left-3  top-1 z-10"
            >
              <i className="ri-arrow-left-s-line text-Black text-2xl"></i>
            </button>
            <button
              type="button"
              className="menu-button-next absolute -right-3 top-1 z-10"
            >
